import { Button as HeadlessButton, type ButtonProps as HeadlessButtonProps, DataInteractive as HeadlessDataInteractive } from '@headlessui/react'
...
const styles = {
  base: [
    // Base
    'relative isolate pointer-events-auto inline-flex items-center justify-center gap-x-2 rounded-lg border text-base/6 font-semibold',
